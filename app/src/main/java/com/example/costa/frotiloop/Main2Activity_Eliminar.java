...
public class Main2Activity_Eliminar extends AppCompatActivity {

    private ListView lv1;
    private EditText et_id;
    private TextView tv_eliminar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main2__eliminar);
        ...
        tv_eliminar=(TextView)findViewById(R.id.textView2);

        Typeface fuente = Typeface.createFromAsset(getAssets(), "fuentes/patito.ttf");
        tv_eliminar.setTypeface(fuente);
        tv_eliminar.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ad_error, 0, 0, 0);
    ...
    public void Eliminar(View view) {
        ...
        int cantidad = db.delete("puntaje", "codigo=" + et_id.getText().toString(), null);
        if (cantidad == 1) {
            toastCorrecto("Se borro el jugador con codigo " + et_id.getText().toString(), 4000);
            et_id.setText("");
            cargarListView();

        } else {
            toastIncorrecto("No existe el codigo " + et_id.getText().toString(), 4000);
            et_id.setText("");
        }
        db.close();
    }

...
public class Main2Activity_EstadisticaTree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main2__estadistica_tree);
        ...
        visitantes.add(new BarEntry(8, 6));
        visitantes.add(new BarEntry(9, 11));
        visitantes.add(new BarEntry(10, 17));
        visitantes.add(new BarEntry(11, 21));
        //tenia 217 antes de cambiarlo
        visitantes.add(new BarEntry(12, 82));

        BarDataSet barDataSet = new BarDataSet(visitantes, "Cantidad de juegos por mes");
        barDataSet.setColors(
                ColorTemplate.rgb("#EE0941"), ColorTemplate.rgb("#09CBEE"), ColorTemplate.rgb("#6AEE09"),
                ColorTemplate.rgb("#FF7400"), ColorTemplate.rgb("#8700FF"));

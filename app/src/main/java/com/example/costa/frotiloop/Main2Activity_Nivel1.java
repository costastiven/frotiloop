...
public class Main2Activity_Nivel1 extends AppCompatActivity {
    ...
    int aciertos1, fallos1;

    int contador_puntos_extra;
    int conteo_extra_puntos = 0;

    boolean avanzar_nivel = false;
        ...
        if (!respuesta.equals("")) {//con esto decimos que si el campo no esta vacio entra por aca
            ...
            if (resultado == respuesta_jugador)//si el resultado del ususario es correcto entra por aca
            {
                ...
                if (conteo_extra_puntos == 3) {
                    ...
                    //Importante declarar el txextra aqui
                    tv_extra.setText("Puntos Extra: " + contador_puntos_extra);
    ...
    public void NumAleatorio() {
        if (score <= 9) {//esto es para que se mantenga dentro del nivel 1 ya que el nivel 1 corresponde a un score maximo de 10
            ...
            if (resultado > 10) {//esto es para controlar que el resultado siempre este dentro del rango del nivel 1
            ...
            } else {//con este metodo recursivo vamos a decirle que si el resultado no es menor o igual a 10 que vuelva a ejecutarlo hasta que sea menor o igual a 10
                NumAleatorio();
            }
        } else {//con esto si el jugador lleva un score de mas de 10 avanza al nivel 2
            AciertosFallos();

            Intent level2 = new Intent(getBaseContext(), Main2Activity_Nivel2.class);
    ...
    public void AciertosFallos() {
        ...
        SQLiteDatabase db = admin.getWritableDatabase();
        ContentValues registro = new ContentValues();
        registro.put("aciertos1", aciertos1);
        registro.put("fallos1", fallos1);
        db.insert("AciertosFallos", null, registro);
        db.close();
    }

    public void dialogo_inicio_nivel() {
        AlertDialog.Builder builder = new AlertDialog.Builder(Main2Activity_Nivel1.this);
        LayoutInflater inflater = getLayoutInflater();
        ...
        txt_bienvenida.setText(" ¡Bienvenido al Nivel 1!");
        txt_logro_dispo.setText(" Logros disponibles: ");
        txt_logro1.setText(" Acierta 3 operaciones seguidas y gana 5 Puntos extra.");
        txt_logro2.setText(" Supera todos los desafíos del Nivel 1 y gana una vida extra.");
    ...
    public void mostrarDialogo() {
        ...
        for (int i = 0; i < len; i++) {
            if (i >= str1.length() || i >= str2.length() || str1.charAt(i) != str2.charAt(i)) {
                ...
                txt4.setText("Sumaste mal las " + texto_medidas[avance_medidas_array]);
                break;
            }

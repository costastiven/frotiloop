...
public class Main2Activity_Nivel4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Recibir los puntos extra del jugador
    ...
    public void NumAleatorio() {
        if (score <= 99) {//esto es para que se mantenga dentro del nivel 1 ya que el nivel 1 corresponde a un score maximo de 10
            numAleatorio_uno = (int) (Math.random() * 898) + 100;
            ...
            int resto = numAleatorio_uno % numAleatorio_dos;
            //ahora vamos a controlar que no existan resultados negativos con esta condicion
            //Si queremos que el reso siempre sea 0 debemos agregar resto==0
            if (resultado % 2 == 0) {

                //fuentes
                Typeface numbers = Typeface.createFromAsset(getAssets(), "fuentes/boxi.otf");
                Typeface raya = Typeface.createFromAsset(getAssets(), "fuentes/chesse.ttf");
            ...
            completado = 1;//llamamos a completado y le asignamos un 1 para que lo almacene
            dialogo_game_over();
        }
    }
    ...
    public void AciertosFallos() {
        ...
        SQLiteDatabase db = admin.getWritableDatabase();
        ContentValues registro = new ContentValues();
        registro.put("aciertos4", aciertos4);
        registro.put("fallos4", fallos4);
        db.insert("AciertosFallos", null, registro);
        db.close();
    }

    public void dialogo_inicio_nivel() {
        AlertDialog.Builder builder = new AlertDialog.Builder(Main2Activity_Nivel4.this);
        LayoutInflater inflater = getLayoutInflater();
    ...
    public void mostrarDialogo() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Main2Activity_Nivel4.this);
        LayoutInflater inflater = getLayoutInflater();
        View vista = inflater.inflate(R.layout.dialogo_error_divi, null);
        builder.setView(vista);
        builder.setCancelable(false);
        ...
        int resto_division = numAleatorio_uno % numAleatorio_dos;
        ...
        //Corregir el resto de la divi
        txt1.setText("Respuesta Incorrecta");
        txt2.setText("\nCociente correcto: " + resultado);
        txt3.setText("\nResto de la división: " + resto_division);
        txt4.setText("\nResultado ingresado: " + respuesta_jugador);
    ...
    public void dialogo_game_over() {
        ...
        if (vidas == 0) {
            ...
            txt_game_1.setText(" ¡Juego Completado!");
            txt_game_5.setText(" ¡Insignia desbloqueada!");
            txt_game_5.setCompoundDrawablesWithIntrinsicBounds(R.drawable.a_rank4, 0, 0, 0);
        }
